    ...
    <div class="full-bleed">
        <div class="page-wrap">
            ...
            <div class="d-flex flex-wrap align-items-start justify-content-between gap-2 mb-3">
                <div>
                    <h2 class="page-title">Turnos de Trabajo</h2>
                    <div class="subtle">Administrá franjas horarias (alta / edición / activar o desactivar)</div>
                    <div class="pillbar">
                        <span class="pill">🕒 Horarios</span>
                        <span class="pill">✅ Activos / inactivos</span>
                        <span class="pill">✏️ Edición rápida</span>
                    </div>
                </div>
            ...
            <div class="card card-soft shadow-sm mb-3">
                <div class="card-header py-3">
                    ...
                    <small class="subtle">Buscá por nombre y elegí si querés incluir inactivos</small>
                </div>
                ...
                <div class="card-body">
                    ...
                    <asp:Label ID="lblMensaje" runat="server"
                        CssClass="alert alert-danger d-block mt-3 mb-0"
                        Visible="false"
            ...
            <div class="card card-soft shadow-sm">
                <div class="card-header py-3 d-flex align-items-center justify-content-between">
                    <div>
                        ...
                        <small class="subtle">Turnos de trabajo cargados en el sistema</small>
                    </div>
                </div>
