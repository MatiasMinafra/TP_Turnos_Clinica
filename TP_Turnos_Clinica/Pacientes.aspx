        ...
        <div class="page-wrap">
            ...
            <div class="d-flex flex-wrap align-items-start justify-content-between gap-2 mb-3">
                <div>
                    ...
                    <div class="subtle">Administración y gestión de pacientes registrados</div>
                    <div class="pillbar">
            ...
            <div class="card card-soft shadow-sm mb-3">
                <div class="card-header py-3">
                    ...
                    <small class="subtle">Buscá por DNI, nombre, apellido o email</small>
                </div>
            ...
            <div class="card card-soft shadow-sm">
                <div class="card-header py-3">
                    ...
                    <small class="subtle">Pacientes cargados en el sistema</small>
                </div>
