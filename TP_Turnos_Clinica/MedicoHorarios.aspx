<%@ Page Title="Horarios por médico" Language="C#" MasterPageFile="~/Site.Master"
    AutoEventWireup="true" CodeBehind="MedicoHorarios.aspx.cs"
    Inherits="TP_Turnos_Clinica.MedicoHorarios" %>

<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">

    <h3 class="mb-3">Horarios por médico</h3>
