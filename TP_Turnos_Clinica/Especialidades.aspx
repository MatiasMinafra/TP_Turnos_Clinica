        ...
        <div class="page-wrap">
            ...
            <div class="d-flex flex-wrap align-items-start justify-content-between gap-2 mb-3">
                <div>
                    ...
                    <div class="subtle">Alta, edición y activación de especialidades</div>
                    <div class="pillbar">
                        <span class="pill">🩺 Catálogo</span>
                        <span class="pill">✅ Activo / inactivo</span>
                        <span class="pill">✏️ Edición</span>
                    </div>
                </div>

                <a class="btn btn-success btn-chip shadow-sm"
                   href="<%= ResolveUrl("~/EspecialidadesForm.aspx") %>">
                    Nueva Especialidad
                </a>
            </div>
            ...
            <div class="card card-soft shadow-sm">
                <div class="card-header py-3 d-flex align-items-center justify-content-between">
                    <div>
                        ...
                        <small class="subtle">Especialidades cargadas en el sistema</small>
                    </div>
                </div>
